...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '951e8907-6812-48aa-a1bd-1dfc4b068b9e' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('3eaf4a38-2597-477b-a4de-6fb9104c1ca1');
      cy.get(`[data-cy="name"]`).should('have.value', '3eaf4a38-2597-477b-a4de-6fb9104c1ca1');
